...
class Curtida(models.Model):
    ...
    iduser = models.ForeignKey(get_user_model(), on_delete=models.PROTECT, related_name="curtidas")
    idnoticia = models.ForeignKey(Noticia, on_delete=models.PROTECT, related_name="curtidas")
